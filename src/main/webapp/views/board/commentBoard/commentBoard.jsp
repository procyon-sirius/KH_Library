	    ...
	    <div id="body-wrap">
				...
				<c:forEach items="${list }" var="b">
					<div class="item">
						<div class="thumbnail" align="center">
							<input type="hidden" value="${b.bookId }"> <!-- 글번호 숨겨넣기 -->
							<img class="bookC" src="/library/resources/img/${b.bookId}.gif" width="280px" height="380px">
						</div>
							<p class="left-align" >
								<b>${b.bookTitle }</b> <br>
								${b.bookAuthor }
		    ...
		    <div align="center" class="pageBtn">
                ...
                <c:if test="${pi.currentPage != 1 }">
                    <button onclick="location.href='commentBoard?currentPage=${pi.currentPage-1}'">이전</button>
                </c:if>
