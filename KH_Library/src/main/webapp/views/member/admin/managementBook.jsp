...
#management-book-table>tbody a:hover{
	...
	<div id="management-book-area">
		<div id="management-book-search">
			<div id="m-b-insert-div">
				...
				<button type="button" id="m-b-updateCategory-btn">카테고리
					추가/삭제</button>
				<script>
		...
		<script>
			//책 수정 페이지
			$(function(){
				$("#management-book-table>tbody").on("click","a",function(){
					var bookId = $(this).parents("tr").find(".m-bid").text();
					location.href="${contextPath}/updateBook.ma?bookId="+bookId;
				})
			})
		</script>
		<script>
